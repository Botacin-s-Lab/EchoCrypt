...
for epoch in range(num_epochs):
    ...
    if val_accuracy > best_val_accuracy:
        ...
        epochs_no_improve = 0
        # Save the best model
        torch.save(model.state_dict(), f'{seed_num}/best_model_zoom_{selected_model}.pth')
...
# Load the best model 
model.load_state_dict(torch.load(f'{seed_num}/best_model_zoom_{selected_model}.pth'))
...
with open(f"{seed_num}/classification_report_zoom_{selected_model}.txt", "w") as file:
