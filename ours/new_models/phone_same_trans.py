...
for epoch in range(num_epochs):
    ...
    if val_accuracy > best_val_accuracy:
        ...
        epochs_no_improve = 0
        # Save the best model
        torch.save(model.state_dict(), f'best_model_phone_st_{selected_model}.pth')
...
# Load the best model 
model.load_state_dict(torch.load(f'best_model_phone_st_{selected_model}.pth'))
...
with open(f"classification_report_phone_st_{selected_model}.txt", "w") as file:
